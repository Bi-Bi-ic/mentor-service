...
type PostRepository interface {
	...
	Create(post models.Post, CreatorID string) (u.ResultRepository, int)
	CreateIntroduction(models.Post, string) (RepoResponse, Status)

	GetPostDetails(string) (models.Post, Status)
	GetPostByID(string) (models.Post, Status)
	...
	/*Like Post*/
	UpdatePostLike(models.Post) (models.Post, Status)
	/* Tracking */
	UpdatePostReview(models.Post) (models.Post, Status)

	GetFeaturePosts() ([]models.Post, Status)
	GetPostsList() ([]models.Post, Status)
}
